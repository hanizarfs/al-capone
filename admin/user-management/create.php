...
<body>
    ...
    <aside class="collapse show collapse-horizontal col-sm-2 p-3 border-end d-none d-lg-block" id="collapseWidthExample">
        ...
        <ul class="list-unstyled ps-0" id="sidebar">
            ...
            <li class="mb-2">
                <a href="../cancellationRequest.php" class="btn btn-toggle d-inline-flex align-items-center rounded border-0 collapsed rounded-3 w-100"> <i class="bi bi-x-circle-fill me-2"></i> Cancellation Requests </a>
            </li>
            <li class="mb-2">
        ...
        <section id="main-content">
            <div class="container">
                ...
                <div class="section-header mb-4">
                    <p>Fill in the form below to create a new user account and assign them a role (Admin or User). After creating the user, they will be able to log in and access the system according to their assigned role.</p>
